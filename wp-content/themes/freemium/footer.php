...
<footer class="footer-main clearfix">
  ...
  <div class="col-md-12 no-padding-lr footer-bootm">
	...
	<?php _e('Powered by ','freemium'); ?><a href='http://fasterthemes.com/wordpress-themes/freemium' target='_blank'><?php _e('Freemium WordPress Theme.','freemium'); ?></a>
      </p>
    </div>
  </div>
</footer>
