...
function fastertheme_framework_page(){ 
		...
		echo "<h1><img src='".$freemium_image."' height='64px'  /> ". __( 'FasterThemes Options', 'freemium' ) . "</h1>"; 
		if ( false !== $_REQUEST['settings-updated'] ) :
			echo "<div><p><strong>"._e( 'Options saved', 'freemium' )."</strong></p></div>";
		endif; ?>
  ...
  <div id="fasterthemes_framework-metabox" class="metabox-holder">
    <div id="fasterthemes_framework" class="postbox"> 
      ...
      <form method="post" action="options.php" id="form-option" class="theme_option_ft">
        ...
        <div id="options-group-1" class="group basicsettings">
          ...
          <div id="section-logo" class="section section-upload ">
            ...
            <div class="option">
              <div class="controls">
                <input id="logo" class="upload" type="text" name="faster_theme_options[logo]" value="<?php if(!empty($freemium_options['logo'])) { echo esc_url($freemium_options['logo']); } ?>" placeholder="<?php _e('No file chosen','freemium'); ?>" />
          ...
          <div id="section-logo" class="section section-upload ">
            ...
            <div class="option">
              <div class="controls">
                <input id="logo" class="upload" type="text" name="faster_theme_options[fevicon]" value="<?php if(!empty($freemium_options['fevicon'])) { echo esc_url($freemium_options['fevicon']); } ?>" placeholder="<?php _e('No file chosen','freemium'); ?>" />
                <input id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload','freemium'); ?>" />
                <div class="screenshot" id="logo-image">
        ...
        <div id="options-group-3" class="group socialsettings">
          ...
          <div id="section-address" class="section section-textarea">
            ...
            <div class="option">
              <div class="controls">
                <textarea id="address" class="of-input" name="faster_theme_options[address]" size="32"><?php if(!empty($freemium_options['address'])) { echo $freemium_options['address']; } ?></textarea>
              </div>
        ...
        <div class="option">
          <div class="controls">
            <input id="section-icon-<?php echo $freemium_j;?>" class="upload" type="text" name="faster_theme_options[section-icon-<?php echo $freemium_j; ?>]" value="<?php if(!empty($freemium_options['section-icon-'.$freemium_j])) echo esc_url($freemium_options['section-icon-'.$freemium_j]); ?>" placeholder="<?php _e('No file chosen','freemium'); ?>" />
     ...
     $cat_id=array_unique($cat_id);
        ...
        <div class="option">
          <div class="controls">
            <input id="area-img" class="upload" type="text" name="faster_theme_options[area-img]" value="<?php if(!empty($freemium_options['area-img'])) echo $freemium_options['area-img']; ?>" placeholder="<?php _e('No file chosen','freemium'); ?>" />
            <input id="icon" class="upload-button button" type="button" value="<?php _e('Upload','freemium'); ?>" />
