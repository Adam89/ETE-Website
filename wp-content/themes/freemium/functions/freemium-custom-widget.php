...
class freemium_post_comment_tag_widget extends WP_Widget {
	function freemium_post_comment_tag_widget() {
		...
		parent::__construct( 'post-comment-tag-widget', __('Posts Comments and Tags', 'freemium'), $freemium_widget_ops, $freemium_control_ops );
	}
...
<?php }
	...
	function form( $instance ) {
		...
		$freemium_defaults = array( 'title' => __('post_comment_tag', 'freemium'), 'name' => __('Posts Comments and Tags', 'freemium'), 'show_info' => true );
